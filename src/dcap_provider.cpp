...
namespace headers
{
static constexpr char PCK_CERT_ISSUER_CHAIN[] =
    "SGX-PCK-Certificate-Issuer-Chain";
static constexpr char CRL_ISSUER_CHAIN[] =
    "SGX-PCK-CRL-Issuer-Chain";
static constexpr char TCB_INFO_ISSUER_CHAIN[] =
    "SGX-TCB-Info-Issuer-Chain";
static constexpr char TCB_INFO[] =
    "SGX-TCBm";
};
